        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Resource = table.Column<byte>(nullable: false),
                    Status = table.Column<bool>(nullable: false),
                    UnfollowOption = table.Column<byte>(nullable: false),
                    WhereUserResource = table.Column<byte>(nullable: false),
                    DirectMessageSource = table.Column<byte>(nullable: false),
                    GeoraphicalLocations = table.Column<string>(nullable: true),
                    PostsShortCode = table.Column<string>(nullable: true),
                    UserList = table.Column<string>(nullable: true),
                    Username = table.Column<string>(maxLength: 255, nullable: true),
                    InteractWithPosts = table.Column<bool>(nullable: false),
                    InteractWithPostsDays = table.Column<byte>(nullable: false),
                    IntervalSpeed = table.Column<int>(nullable: false),
                    IsDeleteAfterSendingMessage = table.Column<bool>(nullable: false),
                    IsSkipSentMessage = table.Column<bool>(nullable: false),
                    MaximumNumberTransactions = table.Column<short>(nullable: false),
                    NumberTransactions = table.Column<short>(nullable: false),
                    DirectMessageId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskId = table.Column<int>(nullable: false),
                    InstagramUserId = table.Column<string>(maxLength: 255, nullable: false),
                    InstagramUserName = table.Column<string>(maxLength: 255, nullable: false),
