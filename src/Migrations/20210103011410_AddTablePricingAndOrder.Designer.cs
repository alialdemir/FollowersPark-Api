...
namespace FollowersPark.Migrations
{
    ...
    [Migration("20210103011410_AddTablePricingAndOrder")]
    partial class AddTablePricingAndOrder
    {
            ...
            modelBuilder.Entity("FollowersPark.DataAccess.Tables.Pricing", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PricingId = 1,
                            CreatedDate = new DateTime(2021, 1, 3, 4, 14, 9, 326, DateTimeKind.Local).AddTicks(9757),
                            Currency = "₺",
                            Deleted = false,
                            IsActive = true,
                            IsBestSeller = false,
                        ...
                        {
                            PricingId = 2,
                            CreatedDate = new DateTime(2021, 1, 3, 4, 14, 9, 329, DateTimeKind.Local).AddTicks(7692),
                            Currency = "₺",
                            Deleted = false,
                            IsActive = true,
                            IsBestSeller = true,
                        ...
                        {
                            PricingId = 3,
                            CreatedDate = new DateTime(2021, 1, 3, 4, 14, 9, 329, DateTimeKind.Local).AddTicks(8654),
                            Currency = "₺",
                            Deleted = false,
                            IsActive = true,
                            IsBestSeller = false,
                        ...
                        {
                            PricingId = 4,
                            CreatedDate = new DateTime(2021, 1, 3, 4, 14, 9, 329, DateTimeKind.Local).AddTicks(8690),
                            Currency = "₺",
                            Deleted = false,
                            IsActive = true,
                            IsBestSeller = false,
